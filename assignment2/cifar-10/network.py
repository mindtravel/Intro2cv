...
def cnn1(num_class):
    ...
    nn.Conv2d(32, 32, kernel_size=3, stride=1, padding=1),  # -> [batch, 32, 32, 32]
    nn.BatchNorm2d(32),
    nn.ReLU(),
    
    # nn.Conv2d(32, 32, kernel_size=1, stride=1),  # -> [batch, 32, 32, 32]
    # nn.BatchNorm2d(32),
    # nn.ReLU(),
    
    nn.MaxPool2d(kernel_size=2, stride=2),  # -> [batch, 32, 16, 16]

    nn.Conv2d(32, 32, kernel_size=3, stride=1, padding=1),  # -> [batch, 64, 16, 16]
    nn.BatchNorm2d(32),
    nn.ReLU(),
    ...
    nn.Conv2d(64, 64, kernel_size=3, stride=1, padding=1),  # -> [batch, 128, 8, 8]
    nn.BatchNorm2d(64),
    nn.ReLU(),
